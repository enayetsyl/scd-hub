...
const STR_BN = {
  ...
  scAxisSkill: "দক্ষতা",
  scFloorHint: "১৫ নম্বরের কম হলে কোনো রায় দেওয়া হয় না — ওই টপিকে আরও প্রশ্ন দিলে হিসাব শুরু হবে।",
...
const STR_EN: StrTable = {
  ...
  scAxisSkill: "Skill",
  scFloorHint: "No verdict under 15 marks — set more questions on that topic and it starts counting.",
