...
const STR_BN = {
  ...
  scAxisSkill: "দক্ষতা",
  scFloorHint: "রায় দিতে হলে ১৫ নম্বর লাগে, নয়তো দুইটি আলাদা প্রশ্নপত্র — যেকোনো একটি হলেই চলবে।",
...
const STR_EN: StrTable = {
  ...
  scAxisSkill: "Skill",
  scFloorHint: "A verdict needs 15 marks or two separate papers — either one is enough.",
