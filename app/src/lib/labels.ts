...
const STR_BN = {
  ...
  shBackup: "ব্যাকআপ",
  shBackupOff: "ব্যাকআপ চালু নেই — ডেটা হারালে ফেরানোর উপায় নেই",
  shBackupNever: "এখনো কোনো ব্যাকআপ হয়নি",
  shBackupLast: "শেষ ব্যাকআপ",
  shBackupDaysAgo: "দিন আগে",
  shBackupFailed: "শেষ চেষ্টা ব্যর্থ",
...
const STR_EN: StrTable = {
  ...
  shSecondsAgo: "s ago",
  shBackup: "Backup",
  shBackupOff: "Backups are off — there is no way back from a data loss",
  shBackupNever: "No backup has ever run",
  shBackupLast: "Last backup",
  shBackupDaysAgo: "days ago",
  shBackupFailed: "Last attempt failed",
