...
/**
 * The tray summary. `minutes` is the basket's EXAM time (QT-1, D-#593) — omitted when 0,
...
const STR_BN = {
  ...
  quUsedIn: "সেটে ব্যবহৃত",
  quUsedInTitle: "কোথায় ব্যবহার হয়েছে",
  quNeverUsed: "এখনো কোনো সেটে ব্যবহার হয়নি।",
  qbChapter: "অধ্যায়",
  ...
  examMinutes: "পরীক্ষার সময় (মিনিট)",
  ...
  wcRejectNoteRequired: "“অন্যান্য” বাছাই করলে কারণটি লিখতে হবে।",
  ...
  // AG-3 — the gift card on the Office's Today screen (class-wise handover)
  agTodayTitle: "🎁 সাপ্তাহিক উপহার — কোন শ্রেণিতে কে পেল",
  agWeek: "সপ্তাহ",
  agWinners: "বিজয়ী",
  agOutstanding: "বাকি আছে",
  agRoll: "রোল",
  agUndone: "উপহার ফিরিয়ে নেওয়া হয়েছে",
  agNoWinnersThisWeek: "এই সপ্তাহে এখনো কোনো বিজয়ী নেই",
  ...
  qrMoveTitle: "অধ্যায় অন্য শিক্ষককে দিন",
  qrMoveFrom: "কার কাছ থেকে নেবেন",
  qrMoveTo: "কাকে দেবেন",
  qrMoveHint: "যেসব প্রশ্নে তিনি এখনো সিদ্ধান্ত দেননি শুধু সেগুলোই যাবে; সিদ্ধান্ত হয়ে যাওয়া প্রশ্ন তাঁর কাছেই থাকবে।",
  qrMoveHolds: "তিনি এখন যা ধরে আছেন",
  qrMoveGo: "সরিয়ে দিন",
  qrMoveConfirm: "টি প্রশ্ন সরাবেন?",
  qrMoved: "সরানো হয়েছে",
  qrMoveKept: "সিদ্ধান্ত হয়ে যাওয়ায় রয়ে গেছে",
  qrMoveNone: "এই অধ্যায়গুলোতে তাঁর কোনো বকেয়া কাজ নেই।",
  ...
  stfNoLogin: "লগইন নেই",
  stfOnProbationNotice: "প্রবেশন — স্থায়ীকরণের তারিখ এখনো নির্ধারিত হয়নি। এই সময়ের সব ছুটি অবৈতনিক হিসেবে জমা থাকছে।",
  ...
  stfConfirmHeldDeduct: "প্রবেশনকালীন জমা কর্তন",
  ...
  stfJoinProbationNote: "নতুন কর্মী প্রবেশন হিসেবেই শুরু করেন। স্থায়ীকরণের তারিখ পরে প্রোফাইল থেকে দেওয়া হবে।",
  ...
  stfPoolNotDrawableYet: "প্রবেশন অবস্থায় এই দিনগুলো ব্যবহার করা যাবে না — এখন ছুটি নিলে তা অবৈতনিক হিসেবে জমা থাকবে।",
  stfDayRate: "দিন-হার (আনুমানিক)",
  stfDayRateFrom: "সর্বশেষ বেতন-রান অনুযায়ী —",
  stfDayRateBasis: "এখনো কোনো বেতন-রান হয়নি। বেতন-রানে মাসের কর্মদিবস দিয়ে ভাগ করা হয়, তাই আসল হার এর চেয়ে বেশি হতে পারে।",
  ...
  stfProbationMonths: "প্রবেশনকাল (মাস)",
  stfProbationEnds: "প্রবেশনকাল শেষ",
  stfProbationOverdue: "প্রবেশনকাল শেষ হয়ে গেছে — স্থায়ীকরণ বাকি",
  ...
  stfPolicyContractNote: "বাংলা নিয়োগ চুক্তিপত্রে এই তথ্যগুলোই ছাপা হয়। খালি থাকলে চুক্তিপত্র তৈরি হবে না।",
  stfPolicyLetterheadNote: "ব্যাংকে পাঠানো বেতনের চিঠিতে এই তথ্যগুলোই ছাপা হয়। খালি থাকলে চিঠি তৈরি হবে না।",
  ...
  stfAdjustmentAdvanceRecovery: "অগ্রিম কর্তন (এককালীন)",
  stfAdjustmentAdvanceRecoveryHint: "এই রানে অগ্রিমের পুরো বকেয়া কাটা হবে। না চাইলে সারিটি মুছে দিন।",
  ...
  stfPolicyProbation: "প্রবেশনকালীন ছুটি জমা রাখা",
  ...
  // Withdraw / correct / remove (owner ask 2026-09-15)
  cqStatusCancelled: "বাতিল",
  cqEdit: "সংশোধন করুন",
  cqEditSave: "সংশোধন সংরক্ষণ করুন",
  cqEditCancel: "থাক",
  cqEditedOk: "অনুরোধ সংশোধন হয়েছে — অফিসকে জানানো হয়েছে",
  cqCancel: "অনুরোধ বাতিল করুন",
  cqCancelReason: "কেন বাতিল করছেন (ঐচ্ছিক)",
  cqCancelSubmit: "বাতিল নিশ্চিত করুন",
  cqCancelConfirmTitle: "অনুরোধ বাতিল করবেন?",
  cqCancelConfirmBody: "অফিস দেখতে পাবে যে আপনি অনুরোধটি বাতিল করেছেন। বাতিল করলে আর ফেরানো যাবে না — নতুন অনুরোধ করতে হবে।",
  cqCancelledOk: "অনুরোধ বাতিল হয়েছে",
  cqCancelledBy: "শিক্ষক বাতিল করেছেন",
  cqDelete: "মুছে দিন",
  cqDeleteReason: "কেন মুছছেন (ঐচ্ছিক)",
  cqDeleteSubmit: "মুছে ফেলা নিশ্চিত করুন",
  cqDeleteConfirmTitle: "অনুরোধটি মুছে দেবেন?",
  cqDeleteConfirmBody: "অনুরোধটি দুই তালিকা থেকেই সরে যাবে এবং অনুরোধকারী শিক্ষককে জানানো হবে।",
  cqDeletedOk: "অনুরোধ মুছে ফেলা হয়েছে",
  ...
  obsSubjectGroupId: "সাবজেক্ট-গ্রুপ",
  obsPickSubjectGroup: "সাবজেক্ট-গ্রুপ নির্বাচন করুন",
  obsNoSubjectGroups: "এই বিষয়ের জন্য কোনো সাবজেক্ট-গ্রুপ নেই",
  ...
  mpCtUnsubmitted: "জমা দেওয়া হয়নি",
  ...
  syHeldBy: "যার কাছে আছে",
  syApprovedBy: "অনুমোদন করেছেন",
  syApprovedByBypass: "প্রধান শিক্ষক নিজে অনুমোদন করেছেন (রুটিনে এই বিষয়ের শিক্ষক নেই)",
  syAwaitingTeacherFrom: "অপেক্ষায় আছে",
  syReassign: "অন্য শিক্ষকের কাছে পাঠান",
  syReassignTo: "নতুন শিক্ষক",
  syReassignDone: "নতুন শিক্ষকের কাছে পাঠানো হয়েছে",
  syReassignOnlyTeacherStage: "অনুমোদন হয়ে গেছে — আর অন্য শিক্ষকের কাছে পাঠানো যাবে না।",
  ...
  scTitle: "বৃত্তি অনুশীলন",
  scDrawerGroup: "বৃত্তি অনুশীলন",
  scPapers: "অনুশীলন প্রশ্ন",
  scNewPaper: "নতুন প্রশ্ন ঘোষণা",
  scDeclare: "প্রশ্ন ঘোষণা",
  scDeclareAction: "ঘোষণা করুন",
  scMarks: "নম্বর এন্ট্রি",
  scAnalysis: "বিশ্লেষণ",
  scClassAnalysis: "শ্রেণি বিশ্লেষণ",
  scTopics: "টপিক তালিকা",
  scPaperName: "প্রশ্নপত্রের নাম",
  scPaperDate: "তারিখ",
  scTotalMarks: "পূর্ণমান",
  scDuration: "সময় (মিনিট)",
  scSubjects: "বিষয়",
  scSourceNote: "উৎস (ঐচ্ছিক)",
  scItems: "আইটেম তালিকা",
  scAddItem: "আইটেম যোগ করুন",
  scItemLabel: "আইটেমের নাম (ঐচ্ছিক)",
  scItemQuestionNo: "প্রশ্ন নম্বর (ঐচ্ছিক)",
  scItemPart: "অংশ — a / b / c / d (ঐচ্ছিক)",
  scAddAllParts: "সব অংশসহ যোগ করুন",
  scLessonKind: "পাঠের ধরন",
  scLessonPoem: "কবিতা",
  scLessonProse: "গদ্য",
  scLessonKindNote: "বেছে নিলে যে প্রশ্নগুলো এই ধরনের পাঠে হয় না, সেগুলো তালিকা থেকে সরে যাবে — গদ্যে ১ (কবিতা মুখস্থ) ও ১০ (কবিতার মূলভাব), কবিতায় ১১ (গদ্যাংশের মূলভাব)।",
  scSumNote: "যোগফল পূর্ণমানের সমান না হলেও ঘোষণা করা যাবে — সব বিকল্প অংশ যোগ করলে যোগফল বেশি হবেই।",
  scItemTopic: "টপিক",
  scItemChapters: "অধ্যায় (কমা দিয়ে)",
  scItemType: "ধরন",
  scItemMarks: "নম্বর",
  scItemSubject: "বিষয়",
  scSumHint: "যোগফল পূর্ণমানের সমান না হলে ঘোষণা করা যাবে না।",
  scNoItems: "এখনো কোনো আইটেম যোগ করা হয়নি।",
  scRemove: "সরান",
  scPresent: "উপস্থিত",
  scAbsent: "অনুপস্থিত",
  scSave: "সংরক্ষণ করুন",
  scSaved: "নম্বর সংরক্ষণ হয়েছে",
  scDeclared: "প্রশ্ন ঘোষণা হয়েছে",
  scTopicSaved: "টপিক সংরক্ষণ হয়েছে",
  scOf: "মধ্যে",
  scTotal: "মোট",
  ...
  scStatusScored: "নম্বর হয়েছে",
  scStatusPublished: "অভিভাবককে দেওয়া",
  scBandWeak: "দুর্বল",
  scBandFair: "মোটামুটি",
  scBandGood: "ভালো",
  scBandNone: "যথেষ্ট তথ্য নেই",
  scAxisTopic: "টপিক",
  scAxisChapter: "অধ্যায়",
  scAxisSkill: "দক্ষতা",
  scFloorHint: "রায় দিতে হলে ১৫ নম্বর, নয়তো দুইটি আলাদা প্রশ্নপত্র, নয়তো শূন্য নম্বর — যেকোনো একটি হলেই চলবে। শূন্য মানে তথ্যের অভাব নয়, শূন্যই ফল।",
  scBehindClass: "ক্লাসের চেয়ে পিছিয়ে",
  scRankLabel: "অবস্থান",
  scCandidates: "বৃত্তি পরীক্ষার তালিকা",
  scCandidatesNote: "পঞ্চম শ্রেণির সবাই বৃত্তি পরীক্ষা দেয় না। যে দেবে না, তাকে বাদ দিলে সে হিটম্যাপ, অবস্থান ও নম্বরের ঘর থেকে সরে যাবে — তার আগের নম্বর মুছবে না।",
  scCandidatesSitting: "জন পরীক্ষা দেবে",
  scCandidateSitting: "পরীক্ষা দেবে",
  scCandidateNotSitting: "দেবে না",
  scCandidateScored: "প্রশ্নপত্রে নম্বর আছে",
  scCandidateNoMarks: "কোনো নম্বর নেই",
  scCandidateKeptMarks: "বাদ দেওয়া হয়েছে — নম্বরগুলো রয়ে গেছে, তালিকায় ফেরালে আবার হিসাবে আসবে।",
  scCandidateAdded: "তালিকায় যোগ হয়েছে।",
  scCandidateRemoved: "তালিকা থেকে বাদ দেওয়া হয়েছে।",
  scNoStudents: "এই শাখায় কোনো শিক্ষার্থী নেই।",
  scRollNo: "রোল",
  scClassFiveOnly: "বৃত্তি অনুশীলন কেবল পঞ্চম শ্রেণির জন্য — আপনার কোনো পঞ্চম শ্রেণির শাখা নেই।",
  scExportMd: "বিশ্লেষণ নামান (.md)",
  scExportPickSubject: "একটি বিষয় বেছে নিলে সেই বিষয়ের বিশ্লেষণ নামানো যাবে।",
  scExportWebOnly: "ফাইল নামানো আপাতত শুধু ওয়েবে।",
  scExportDone: "ফাইল নামানো হয়েছে।",
  scRankOf: "জনের মধ্যে",
  scTrend: "ধারা",
  scPaperWise: "প্রশ্নপত্র অনুযায়ী",
  scNoRank: "এই টপিকে আর কেউ বসেনি",
  scPapersSat: "প্রশ্নপত্র দিয়েছে",
  scRosterStudents: "শিক্ষার্থী",
  scPickStudent: "শিক্ষার্থী বাছুন",
  scMarksOutOf: "সর্বোচ্চ",
  scReteach: "পুরো ক্লাসই দুর্বল — আবার পড়ানো দরকার।",
  scLegend: "রঙের অর্থ",
  scAddTopic: "টপিক যোগ করুন",
  scTopicLabel: "টপিকের নাম",
  scTopicAxis: "টপিকের ধরন",
  scChapterShort: "অধ্যায়",
} as const;
...
const STR_EN: StrTable = {
  ...
  quUsedIn: "in sets",
  quUsedInTitle: "Where it has been used",
  quNeverUsed: "Not used in any set yet.",
  qbChapter: "Chapter",
  ...
  wcRejectNoteRequired: "Choosing “Other” requires a written reason.",
  ...
  agHandedOverBy: "by",
  // AG-3 — the gift card on the Office's Today screen (class-wise handover)
  agTodayTitle: "🎁 Weekly gift — who won, by class",
  agWeek: "Week",
  agWinners: "Winners",
  agOutstanding: "Still to give",
  agRoll: "Roll",
  agUndone: "Gift handover undone",
  agNoWinnersThisWeek: "No winners yet this week",
  ...
  qrMoveTitle: "Move chapters to another reviewer",
  qrMoveFrom: "Take from",
  qrMoveTo: "Give to",
  qrMoveHint:
    "Only questions they have not decided yet will move; anything they have already ruled on stays with them.",
  qrMoveHolds: "What they hold now",
  qrMoveGo: "Move",
  qrMoveConfirm: " questions — move them?",
  qrMoved: "Moved",
  qrMoveKept: "Kept (already decided)",
  qrMoveNone: "They have nothing outstanding in these chapters.",
  ...
  stfDayRateFrom: "From the latest payroll run —",
  stfDayRateBasis: "No payroll run yet. Payroll divides by the month's working days, so the real rate is usually higher than this.",
  ...
  stfPolicyContractNote: "These are what the Bangla contract prints. Left empty, the contract cannot be issued.",
  stfPolicyLetterheadNote: "These are what the bank salary letter prints. Left empty, the letter cannot be issued.",
  ...
  stfAdjustmentAdvanceRecovery: "Advance recovery (one-off)",
  stfAdjustmentAdvanceRecoveryHint: "This run will recover the whole outstanding advance. Remove the row to skip it.",
  ...
  // Withdraw / correct / remove (owner ask 2026-09-15)
  cqStatusCancelled: "Cancelled",
  cqEdit: "Correct details",
  cqEditSave: "Save corrections",
  cqEditCancel: "Never mind",
  cqEditedOk: "Request corrected — the office has been told",
  cqCancel: "Cancel request",
  cqCancelReason: "Why are you cancelling (optional)",
  cqCancelSubmit: "Confirm cancellation",
  cqCancelConfirmTitle: "Cancel this request?",
  cqCancelConfirmBody: "The office will see that you withdrew it. This cannot be undone — you would need to file a new request.",
  cqCancelledOk: "Request cancelled",
  cqCancelledBy: "Cancelled by the teacher",
  cqDelete: "Delete",
  cqDeleteReason: "Why are you deleting it (optional)",
  cqDeleteSubmit: "Confirm delete",
  cqDeleteConfirmTitle: "Delete this request?",
  cqDeleteConfirmBody: "It leaves both lists and the requesting teacher is notified.",
  cqDeletedOk: "Request deleted",
  ...
  obsSubjectGroupId: "Subject group",
  obsPickSubjectGroup: "Pick a subject group",
  obsNoSubjectGroups: "No subject group exists for this subject",
  ...
  syHeldBy: "With",
  syApprovedBy: "Approved by",
  syApprovedByBypass: "The Principal approved in the teacher's place (no routine teacher for this subject)",
  syAwaitingTeacherFrom: "Waiting on",
  syReassign: "Send to another teacher",
  syReassignTo: "New teacher",
  syReassignDone: "Sent to the new teacher",
  syReassignOnlyTeacherStage: "Already approved — it can no longer be moved to another teacher.",
  ...
  // --- Scholarship practice papers (SC-0..SC-4) ---
  scTitle: "Scholarship practice",
  scDrawerGroup: "Scholarship practice",
  scPapers: "Practice papers",
  scNewPaper: "Declare a paper",
  scDeclare: "Declare a paper",
  scDeclareAction: "Declare",
  scMarks: "Enter marks",
  scAnalysis: "Analysis",
  scClassAnalysis: "Class analysis",
  scTopics: "Topics",
  scPaperName: "Paper name",
  scPaperDate: "Date",
  scTotalMarks: "Full marks",
  scDuration: "Duration (minutes)",
  scSubjects: "Subjects",
  scSourceNote: "Source (optional)",
  scItems: "Items",
  scAddItem: "Add an item",
  scItemLabel: "Item name (optional)",
  scItemQuestionNo: "Question no. (optional)",
  scItemPart: "Part — a / b / c / d (optional)",
  scAddAllParts: "Add with all parts",
  scLessonKind: "Lesson type",
  scLessonPoem: "Poem",
  scLessonProse: "Prose",
  scLessonKindNote: "Choosing one drops the questions that lesson type cannot carry — prose drops 1 (poem recall) and 10 (poem main idea); poem drops 11 (prose main idea).",
  scSumNote: "The items need not total the full marks — a paper listing every alternative always sums higher.",
  scItemTopic: "Topic",
  scItemChapters: "Chapters (comma separated)",
  scItemType: "Type",
  scItemMarks: "Marks",
  scItemSubject: "Subject",
  scSumHint: "The items must total the full marks before a paper can be declared.",
  scNoItems: "No items added yet.",
  scRemove: "Remove",
  scPresent: "Present",
  scAbsent: "Absent",
  scSave: "Save",
  scSaved: "Marks saved",
  scDeclared: "Paper declared",
  scTopicSaved: "Topic saved",
  scOf: "of",
  scTotal: "Total",
  ...
  scStatusScored: "Scored",
  scStatusPublished: "Released",
  scBandWeak: "Weak",
  scBandFair: "Fair",
  scBandGood: "Good",
  scBandNone: "Not enough data",
  scAxisTopic: "Topic",
  scAxisChapter: "Chapter",
  scAxisSkill: "Skill",
  scFloorHint: "A verdict needs 15 marks, or two separate papers, or a score of zero — any one is enough. A zero is a result, not missing data.",
  scBehindClass: "Behind the class",
  scRankLabel: "Position",
  scCandidates: "Scholarship candidates",
  scCandidatesNote: "Not all of class five sits the scholarship examination. Removing a child takes her out of the heat-map, the positions and the mark grid — it does not delete her marks.",
  scCandidatesSitting: "sitting",
  scCandidateSitting: "Sitting",
  scCandidateNotSitting: "Not sitting",
  scCandidateScored: "papers scored",
  scCandidateNoMarks: "no marks yet",
  scCandidateKeptMarks: "Removed — her marks are kept, and come back into the analysis if she is entered again.",
  scCandidateAdded: "Entered for the examination.",
  scCandidateRemoved: "Removed from the examination list.",
  scNoStudents: "No students in this section.",
  scRollNo: "Roll",
  scClassFiveOnly: "Scholarship practice is class five only — you have no class-five section.",
  scExportMd: "Download analysis (.md)",
  scExportPickSubject: "Pick a subject to download that subject's analysis.",
  scExportWebOnly: "Downloads are web-only for now.",
  scExportDone: "File downloaded.",
  scRankOf: "of",
  scTrend: "Trend",
  scPaperWise: "Paper by paper",
  scNoRank: "Nobody else sat this topic",
  scPapersSat: "papers sat",
  scRosterStudents: "Students",
  scPickStudent: "Pick a student",
  scMarksOutOf: "max",
  scReteach: "The whole class is weak here — worth re-teaching.",
  scLegend: "What the colours mean",
  scAddTopic: "Add a topic",
  scTopicLabel: "Topic name",
  scTopicAxis: "Topic kind",
  scChapterShort: "Ch.",
};
