...
const STR_BN = {
  ...
  // Classroom Observation — session footage (CO-2)
  coRecordTitle: "ক্লাস রেকর্ডিং আপলোড",
  coRecordHint: "REF-11 পর্যবেক্ষণের জন্য সেশন ভিডিও (YouTube — unlisted)",
  coClassDate: "ক্লাসের তারিখ",
  coTeacherLabel: "শিক্ষক (যাঁকে পর্যবেক্ষণ করা হবে)",
  coModeUpload: "ভিডিও আপলোড",
  coModeUrl: "YouTube লিংক",
  coAuthorize: "YouTube অনুমোদন করুন",
  coAuthorized: "YouTube অনুমোদিত ✓",
  coPickUpload: "ভিডিও নির্বাচন করে আপলোড করুন",
  coUploadedVideo: "আপলোড হয়েছে — ভিডিও আইডি",
  coUrlLabel: "YouTube লিংক বা ভিডিও আইডি",
  coUrlHint: "ইতিমধ্যে আপলোড করা ভিডিওর লিংক এখানে দিন।",
  coWebOnly: "ভিডিও সরাসরি আপলোড এই ডিভাইসে নেই — আগে থেকে আপলোড করা ভিডিওর YouTube লিংক দিন।",
  coSave: "রেকর্ডিং সংরক্ষণ করুন",
  coSaved: "রেকর্ডিং সংরক্ষিত হয়েছে",
  coWatch: "▶ রেকর্ডিং দেখুন (YouTube)",
  coVideoId: "ভিডিও আইডি",
  coNeedAnchorFirst: "আগে বিষয় ও ক্লাসের তারিখ নির্বাচন করুন।",
...
const STR_EN: StrTable = {
  ...
  // Classroom Observation — session footage (CO-2)
  coRecordTitle: "Class Recording Upload",
  coRecordHint: "Session footage for REF-11 observation (YouTube — unlisted)",
  coClassDate: "Class date",
  coTeacherLabel: "Teacher (being observed)",
  coModeUpload: "Upload video",
  coModeUrl: "YouTube link",
  coAuthorize: "Authorize YouTube",
  coAuthorized: "YouTube authorized ✓",
  coPickUpload: "Pick a video & upload",
  coUploadedVideo: "Uploaded — video id",
  coUrlLabel: "YouTube link or video id",
  coUrlHint: "Paste the link of an already-uploaded video.",
  coWebOnly: "Direct video upload isn't available here — paste the YouTube link of an already-uploaded video.",
  coSave: "Save recording",
  coSaved: "Recording saved",
  coWatch: "▶ Watch recording (YouTube)",
  coVideoId: "Video id",
  coNeedAnchorFirst: "Pick the subject and class date first.",
