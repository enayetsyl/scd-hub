...
import {
  ...
  EXAM_STATUS_LABELS_EN,
  EXAM_COMPONENT_LABELS_BN,
  EXAM_COMPONENT_LABELS_EN,
  EXAM_DUTY_ROLE_LABELS_BN,
  EXAM_DUTY_ROLE_LABELS_EN,
  CUSTODY_STAGE_LABELS_BN,
  CUSTODY_STAGE_LABELS_EN,
  CUSTODY_ITEM_KIND_LABELS_BN,
  CUSTODY_ITEM_KIND_LABELS_EN,
  CUSTODY_EVENT_STATUS_LABELS_BN,
  CUSTODY_EVENT_STATUS_LABELS_EN,
  ...
  type ExamDutyRole,
  type CustodyStage,
  type CustodyItemKind,
  type CustodyEventStatus,
  type GradeLetter,
  type DayOfWeek,
  type PeriodTrack,
...
// Exams (EX-1..EX-9, D-#375–#382). ADAB deliberately renders as "Performance" in EN,
// the name the printed transcript uses — one value, two names (D-#376 note).
export const examTermLabel = (v?: string | null): string =>
  (v && pick(EXAM_TERM_LABELS_BN, EXAM_TERM_LABELS_EN)[v as ExamTerm]) || v || DASH;

export const examStatusLabel = (v?: string | null): string =>
  (v && pick(EXAM_STATUS_LABELS_BN, EXAM_STATUS_LABELS_EN)[v as ExamStatus]) || v || DASH;
...
export const examDutyRoleLabel = (v?: string | null): string =>
  (v && pick(EXAM_DUTY_ROLE_LABELS_BN, EXAM_DUTY_ROLE_LABELS_EN)[v as ExamDutyRole]) || v || DASH;

export const custodyStageLabel = (v?: string | null): string =>
  (v && pick(CUSTODY_STAGE_LABELS_BN, CUSTODY_STAGE_LABELS_EN)[v as CustodyStage]) || v || DASH;

export const custodyItemKindLabel = (v?: string | null): string =>
  (v && pick(CUSTODY_ITEM_KIND_LABELS_BN, CUSTODY_ITEM_KIND_LABELS_EN)[v as CustodyItemKind]) || v || DASH;

export const custodyStatusLabel = (v?: string | null): string =>
  (v && pick(CUSTODY_EVENT_STATUS_LABELS_BN, CUSTODY_EVENT_STATUS_LABELS_EN)[v as CustodyEventStatus]) || v || DASH;

/** The printed glyph for a grade code (A_PLUS → "A+"). */
export const gradeLetterLabel = (v?: string | null): string =>
  (v && GRADE_LETTER_DISPLAY[v as GradeLetter]) || v || DASH;
...
const STR_BN = {
  ...
  exHomeTitle: "পরীক্ষা",
  exExams: "পরীক্ষাসমূহ",
  exNoExams: "এখনও কোনো পরীক্ষা তৈরি হয়নি",
  exPapers: "বিষয়পত্র",
  exNoPapers: "এই পরীক্ষার কোনো বিষয়পত্র নেই",
  exMyDuties: "আমার দায়িত্ব",
  exNoDuties: "এই পরীক্ষায় আপনার কোনো দায়িত্ব নেই",
  exFullMarks: "খাতার পূর্ণমান",
  exTabulated: "সংকলিত",
  exNotTabulated: "সংকলিত হয়নি",
  // mark entry
  exMarkTitle: "নম্বর এন্ট্রি",
  exEnterMarks: "নম্বর দিন",
  exSave: "সংরক্ষণ",
  exEdit: "সম্পাদনা",
  exOutOfRange: "নম্বর বেশি হয়ে গেছে — সর্বোচ্চ",
  exSaved: "নম্বর সংরক্ষিত হয়েছে",
  exPresent: "উপস্থিত",
  exAbsent: "অনুপস্থিত",
  exRawOutOf: "প্রাপ্ত নম্বর (পূর্ণমান",
  exConverted: "রূপান্তরিত",
  exNotEntered: "দেওয়া হয়নি",
  exPullCt: "ক্লাস টেস্ট থেকে CT আনুন",
  exCtPulled: "টি সারিতে CT আনা হয়েছে",
  exCtProposal: "প্রস্তাবিত CT",
  exCtNoHistory: "ক্লাস টেস্টের রেকর্ড নেই — ফাঁকা থাকবে",
  exCtRule: "নিয়ম",
  exNoCtComponent: "এই বিষয়পত্রে CT অংশ নেই",
  // recheck
  exRecheckTitle: "রিচেক",
  exRecheckHidden: "নিজের নম্বর দেওয়ার আগে চেককারীর নম্বর দেখা যাবে না",
  exCheckerMark: "চেককারীর নম্বর",
  exRecheckMark: "রিচেককারীর নম্বর",
  exDivergent: "অমিল",
  exDivergences: "চেক ও রিচেকে অমিল",
  exNoDivergences: "কোনো অমিল নেই",
  exResolve: "মীমাংসা করুন",
  exAgreedMark: "মীমাংসিত নম্বর",
  exResolved: "মীমাংসা সংরক্ষিত হয়েছে",
  exTabulate: "সংকলন সম্পন্ন করুন",
  exTabulateDone: "বিষয়পত্র সংকলিত হয়েছে",
  exReopen: "পুনরায় খুলুন",
  exReopenReason: "পুনরায় খোলার কারণ",
  exReadyToTabulate: "সংকলনের জন্য প্রস্তুত",
  exBlockedBy: "যা বাকি আছে",
  exMissingMarks: "নম্বর বাকি",
  exUnresolved: "অমীমাংসিত অমিল",
  exNotRechecked: "রিচেক বাকি",
  // custody
  exCustodyTitle: "খাতা ও প্রশ্নের হিসাব",
  exCustodyBoard: "হস্তান্তরের হিসাব",
  exWaitingOnYou: "আপনার গ্রহণের অপেক্ষায়",
  exNoPending: "গ্রহণের অপেক্ষায় কিছু নেই",
  exNewHandover: "নতুন হস্তান্তর",
  exHandTo: "যাঁর কাছে দেওয়া হচ্ছে",
  exDeclaredCount: "যতটি দেওয়া হচ্ছে",
  exCountedCount: "আপনি যতটি গুনলেন",
  exAcknowledge: "গ্রহণ স্বীকার করুন",
  exAcknowledged: "গ্রহণ স্বীকার করা হয়েছে",
  exDisputeNote: "গরমিলের কারণ",
  exDisputeNoteRequired: "সংখ্যা না মিললে কারণ লিখতে হবে",
  exDisputed: "গরমিল",
  exHandoverRecorded: "হস্তান্তর নথিভুক্ত হয়েছে",
  exCancelHandover: "বাতিল",
  exStudentsPresent: "উপস্থিত শিক্ষার্থী",
  exBalanced: "হিসাব মিলেছে",
  exNotBalanced: "হিসাব মেলেনি",
  exExceptions: "গরমিল ও অপেক্ষমাণ",
  exNoExceptions: "কোনো গরমিল নেই",
  exNoHandovers: "এখনও কোনো হস্তান্তর নথিভুক্ত হয়নি",
  exStage: "ধাপ",
  exDeclared: "দেওয়া",
  exCounted: "গোনা",
  exPending: "অপেক্ষমাণ",
  // report card
  exReportTitle: "রিপোর্ট কার্ড",
  exSubject: "বিষয়",
  exObtained: "প্রাপ্ত",
  exHighest: "সর্বোচ্চ",
  exGradePoint: "গ্রেড পয়েন্ট",
  exGrade: "গ্রেড",
  exTotalGpa: "মোট / জিপিএ",
  exComment: "স্কুলের মন্তব্য",
  exCommentSaved: "মন্তব্য সংরক্ষিত হয়েছে",
  exFailedBySubject: "একটি বিষয়ে F থাকায় জিপিএ ০.০০",
  exOpenPdf: "পিডিএফ দেখুন",
  exClassBundle: "শ্রেণির সব কার্ড (পিডিএফ)",
  exNoCard: "এই শিক্ষার্থীর কার্ড তৈরি করা যায়নি",
  // publish
  exSubmitResults: "ফলাফল জমা দিন",
  exSubmitted: "ফলাফল অনুমোদনের জন্য জমা হয়েছে",
  exApprove: "অনুমোদন ও প্রকাশ",
  exApproved: "ফলাফল প্রকাশিত হয়েছে",
  exSendBack: "ফেরত পাঠান",
  exSendBackReason: "ফেরত পাঠানোর কারণ",
  exSentBack: "ফলাফল ফেরত পাঠানো হয়েছে",
  exUnpublish: "প্রকাশ প্রত্যাহার",
  exUnpublished: "প্রকাশ প্রত্যাহার করা হয়েছে",
  exPublished: "প্রকাশিত",
  exUnpublishedState: "অপ্রকাশিত",
} as const;
...
const STR_EN: StrTable = {
  ...
  exHomeTitle: "Exams",
  exExams: "Exams",
  exNoExams: "No exam has been created yet",
  exPapers: "Papers",
  exNoPapers: "This exam has no papers",
  exMyDuties: "My duties",
  exNoDuties: "You have no duty on this exam",
  exFullMarks: "Script full marks",
  exTabulated: "Tabulated",
  exNotTabulated: "Not tabulated",
  exMarkTitle: "Mark entry",
  exEnterMarks: "Enter marks",
  exSave: "Save",
  exEdit: "Edit",
  exOutOfRange: "Mark is above the maximum —",
  exSaved: "Marks saved",
  exPresent: "Present",
  exAbsent: "Absent",
  exRawOutOf: "Mark (out of",
  exConverted: "Converted",
  exNotEntered: "Not entered",
  exPullCt: "Pull CT from class tests",
  exCtPulled: "rows pulled",
  exCtProposal: "Proposed CT",
  exCtNoHistory: "No class-test history — stays blank",
  exCtRule: "Rule",
  exNoCtComponent: "This paper has no CT component",
  exRecheckTitle: "Recheck",
  exRecheckHidden: "The checker's mark stays hidden until you enter your own",
  exCheckerMark: "Checker's mark",
  exRecheckMark: "Rechecker's mark",
  exDivergent: "Differs",
  exDivergences: "Checker / rechecker disagreements",
  exNoDivergences: "No disagreements",
  exResolve: "Resolve",
  exAgreedMark: "Agreed mark",
  exResolved: "Resolution saved",
  exTabulate: "Tabulate",
  exTabulateDone: "Paper tabulated",
  exReopen: "Re-open",
  exReopenReason: "Reason for re-opening",
  exReadyToTabulate: "Ready to tabulate",
  exBlockedBy: "Still outstanding",
  exMissingMarks: "marks missing",
  exUnresolved: "unresolved disagreements",
  exNotRechecked: "not rechecked",
  exCustodyTitle: "Script & question custody",
  exCustodyBoard: "Handover balance",
  exWaitingOnYou: "Waiting on you",
  exNoPending: "Nothing awaiting your acknowledgement",
  exNewHandover: "New handover",
  exHandTo: "Hand over to",
  exDeclaredCount: "Count handed over",
  exCountedCount: "Count you made",
  exAcknowledge: "Acknowledge",
  exAcknowledged: "Acknowledged",
  exDisputeNote: "Reason for the difference",
  exDisputeNoteRequired: "A count mismatch needs a reason",
  exDisputed: "Disputed",
  exHandoverRecorded: "Handover recorded",
  exCancelHandover: "Cancel",
  exStudentsPresent: "Students present",
  exBalanced: "Balanced",
  exNotBalanced: "Not balanced",
  exExceptions: "Disputes & stale",
  exNoExceptions: "No exceptions",
  exNoHandovers: "No handover recorded yet",
  exStage: "Stage",
  exDeclared: "Declared",
  exCounted: "Counted",
  exPending: "Pending",
  exReportTitle: "Report card",
  exSubject: "Subject",
  exObtained: "Obtained",
  exHighest: "Highest",
  exGradePoint: "Grade point",
  exGrade: "Grade",
  exTotalGpa: "Total / GPA",
  exComment: "Comment from school",
  exCommentSaved: "Comment saved",
  exFailedBySubject: "GPA 0.00 — a subject was graded F",
  exOpenPdf: "Open PDF",
  exClassBundle: "Whole class (PDF)",
  exNoCard: "Could not build this student's card",
  exSubmitResults: "Submit results",
  exSubmitted: "Results submitted for approval",
  exApprove: "Approve & publish",
  exApproved: "Results published",
  exSendBack: "Send back",
  exSendBackReason: "Reason for sending back",
  exSentBack: "Results sent back",
  exUnpublish: "Unpublish",
  exUnpublished: "Results unpublished",
  exPublished: "Published",
  exUnpublishedState: "Unpublished",
};
