...
const STR_BN = {
  ...
  edDropHint: ".md ফাইল এখানে টেনে আনুন বা বাছাই করুন",
  edOnlyMd: "শুধু .md (মার্কডাউন) ফাইল আপলোড করা যায়",
...
const STR_EN: StrTable = {
  ...
  edDropHint: "Drag .md files here or pick them",
  edOnlyMd: "Only .md (markdown) files can be uploaded",
