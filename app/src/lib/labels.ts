...
const STR_BN = {
  ...
  // Block splitter (D-#455)
  edSplitTitle: "ব্লক ফাইল আলাদা করুন",
  edSplitButton: "শীটগুলো আলাদা করুন",
  edSplitting: "আলাদা করা হচ্ছে…",
  edSplitHint: "ব্লক ফাইল থেকে শিক্ষক শীট, ক্লাসওয়ার্ক, বাড়ির কাজ, প্র্যাকটিস টেস্ট ও উত্তরপত্র তৈরি হবে — আপলোডের আগে দেখে নিন",
  edSplitNeedsClassBlock: "আগে শ্রেণি ও ব্লক নম্বর দিন",
  edSplitDone: "শীট তৈরি হয়েছে — নিচে দেখে নিয়ে আপলোড করুন",
  edSplitByAi: "AI দিয়ে সাজানো",
  edSplitDeterministic: "কেটে আলাদা করা",
  edSplitTopic: "ব্লকের বিষয়",
  edSplitTopicHelper: "শীটের হেডিংয়ে ছাপা হবে — যেমন Countability",
  edSplitUseAi: "AI দিয়ে সাজানো হবে",
  edSplitPreview: "কনটেন্ট দেখুন",
  edSplitPreviewHide: "কনটেন্ট লুকান",
  edBlock: "ব্লক",
...
const STR_EN: StrTable = {
  ...
  // Block splitter (D-#455)
  edSplitTitle: "Split a block file",
  edSplitButton: "Split into sheets",
  edSplitting: "Splitting…",
  edSplitHint:
    "Derives the teacher sheet, classwork, homework, practice test and answer key from the block file — review them before uploading",
  edSplitNeedsClassBlock: "Set the class and block number first",
  edSplitDone: "Sheets derived — review them below, then upload",
  edSplitByAi: "AI-tidied",
  edSplitDeterministic: "Sliced",
  edSplitTopic: "Block topic",
  edSplitTopicHelper: "Printed on every sheet header — e.g. Countability",
  edSplitUseAi: "Tidy with AI",
  edSplitPreview: "Show content",
  edSplitPreviewHide: "Hide content",
  edBlock: "Block",
