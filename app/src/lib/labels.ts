...
const STR_BN = {
  ...
  edRichHint: "লেখা নির্বাচন করে আকার বা লাইনের ফাঁক বদলান · এন্টার চেপে নতুন লাইন · টেবিলে সরাসরি লিখুন · প্রিন্ট ব্রাউজারের প্রিন্ট উইন্ডো থেকে",
  edMarginNarrow: "সরু",
...
const STR_EN: StrTable = {
  ...
  edRichHint: "Select text to change size or line spacing · Enter for a new line · type directly into tables · printing opens the browser's print window",
