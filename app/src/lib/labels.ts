...
const STR_BN = {
  ...
  edQueueHint: "অফিসকে দিয়ে প্রিন্ট করাতে: “প্রিন্ট / প্রিভিউ” → গন্তব্য “Save as PDF” → তারপর “অফিস প্রিন্ট কিউ” চেপে সেই PDF আপলোড করুন।",
  edMarginNarrow: "সরু",
...
const STR_EN: StrTable = {
  ...
  edQueueHint: "To have the office print it: “Print / preview” → destination “Save as PDF” → then “Office print queue” and upload that PDF.",
