...
const STR_BN = {
  ...
  alertHwReconcile: "বাড়ির কাজ রিকনসাইল/ইস্যু করা হয়নি",
  ...
  rrNoMisses: "সব রিকনসিলিয়েশন জমা হয়েছে ✓",
  ...
  rptHwDeclarePending: "হোমওয়ার্ক ঘোষণা বাকি",
  rptHwIssuePending: "হোমওয়ার্ক ইস্যু বাকি",
  ...
  rptCustomRange: "নিজের তারিখ",
  rptFrom: "শুরু",
  rptTo: "শেষ",
  rptNoRows: "এই ফিল্টারে কিছু নেই ✓",
  /** D-#316 — admin Today dashboard cards. */
  dcAttendance: "উপস্থিতি",
  dcHwCycle: "হোমওয়ার্ক — আজকের চক্র",
  dcHwLifecycle: "হোমওয়ার্ক — চেকিং ব্যাকলগ",
  ...
  hwMarkSelectedDue: "নির্বাচিতগুলো ডিউ করুন",
  hwMarkDayDue: "এই দিনের সব ডিউ করুন",
  ...
  asTrim: "কমান",
  asMinutes: "মিনিট",
  asMinutesInvalid: "সময় একটি অঋণাত্মক সংখ্যা হতে হবে।",
  ...
  ctConfirmerHint: "শ্রেণিশিক্ষকের পাশাপাশি এই শিক্ষকও দৈনিক বাড়ির কাজ নিশ্চিত/ইস্যু করতে পারবেন।",
  ...
  admSubGroupMembers: "কুরআন/আরবি গ্রুপে ছাত্র যুক্ত করুন",
  ...
  gmTitle: "গ্রুপ সদস্য",
  gmHint: "কুরআন/আরবি গ্রুপে ছাত্র যুক্ত করুন — যুক্ত না করলে অভিভাবকের রুটিনে সেই ছাত্রের কুরআন/আরবি ক্লাস দেখাবে না। প্রথমে গ্রুপ নির্বাচন করুন, তারপর উপরের সেকশন থেকে ছাত্র যোগ করুন।",
  gmGroup: "গ্রুপ",
  ...
  gmAddFrom: "সেকশন থেকে যোগ করুন",
  gmNoStudents: "এই সেকশনে কোনো ছাত্র নেই।",
  gmAdd: "যোগ করুন",
  gmMember: "সদস্য ✓",
  gmAdded: "ছাত্র গ্রুপে যুক্ত হয়েছে।",
  gmRemoved: "ছাত্র গ্রুপ থেকে সরানো হয়েছে।",
  ...
  alReportSub: "পরিকল্পিত বনাম প্রদত্ত — বিষয় ও শিক্ষক অনুযায়ী",
  ...
  attAdminTitle: "যেকোনো দিনের হাজিরা (অ্যাডমিন)",
  attAdminHint: "যেকোনো শ্রেণির আজকের বা আগের দিনের হাজিরা দিন/সংশোধন করুন — অডিটসহ",
  attAdminDate: "তারিখ",
  attAdminNoUnits: "এই দিনে হাজিরা প্রযোজ্য নয় (ছুটি/বন্ধ) বা কোনো শিক্ষার্থী নেই।",
  ...
  ctWaAdminOnly: "ফলাফল প্রকাশিত হয়েছে — অভিভাবকদের হোয়াটসঅ্যাপ বার্তা অফিস/অধ্যক্ষ পাঠাবেন।",
  ...
  cmDeliverByAdmin: "প্রিন্সিপাল/অফিস এটি পর্যালোচনা করে অভিভাবককে পাঠাবেন।",
  ...
  audHint: "এই লগ কখনো মোছা বা বদলানো যায় না; শুধু প্রিন্সিপাল দেখতে পারেন।",
  ...
  audSystem: "সিস্টেম",
  tabFreeMixing: "ফ্রি মিক্সিং অবজারভেশন",
  vrTitle: "ফ্রি মিক্সিং অবজারভেশন",
  ...
  obsAllObservationsNav: "সকল অবজারভেশন",
  obsAllObservationsTitle: "সকল অবজারভেশন",
  obsNoAllObservations: "কোনো অবজারভেশন পাওয়া যায়নি।",
  obsMyObservationsNav: "আমার অবজারভেশন",
  obsMyObservationsTitle: "আমার অবজারভেশন",
  ...
  obsYoutubeUrl: "YouTube লিংক",
  obsYoutubeUrlHint: "সম্পূর্ণ YouTube লিংক পেস্ট করুন",
