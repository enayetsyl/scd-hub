...
const REGISTRY: Record<string, CardMeta> = {
  ...
  handout: { icon: "📦", titleKey: "dcHandout", target: { tab: "AssignmentTab", screen: "AssignmentHandout" } },
...
const BADGE_LABELS: Record<string, LabelKey> = {
  ...
  handoutPackets: "dcbHandoutPackets",
  handoutSections: "dcbHandoutSections",
  handoutUnprinted: "dcbHandoutUnprinted",
  handoutNoTeacher: "dcbHandoutNoTeacher",
