...
// Version: v0.1 (DRAFT — nothing locked)
// Owner  : Principal
...
//          SCHOOLSW_ImportEnvelope_Schema_v0_1.json (the wire-contract enums).
//
// WHAT THIS FILE IS
...
//   Difficulty, QuestionType, ReviewStatus, SourceProject, AnchorWord) is a
//   two-place edit: this file AND SCHOOLSW_ImportEnvelope_Schema_v0_1.json (and the
...
export const DOC_TYPES = ["chapter_plan", "session_plan", "question", "question_set"] as const;
 ...
 *  PROVISIONAL — the question payload is unratified pending Project 04 (R-IMP5);
 *  this list may change when Project 04 signs off and the payload tightens. */
