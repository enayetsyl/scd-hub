...
check("OFFICE = roster/staff/guardian/message/import", eq(V.permissionsForRole("OFFICE"), ["roster:manage","staff:manage","guardian:link","message:dispatch","content:import"]));
