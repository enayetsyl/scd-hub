...
HrPolicyRef.implement({
  ...
  fields: (t) => ({
    ...
    orgRegistrationNo: t.exposeString("orgRegistrationNo"),
    orgAddress: t.exposeString("orgAddress"),
    orgPhone: t.exposeString("orgPhone"),
    orgEmail: t.exposeString("orgEmail"),
    schoolBankName: t.exposeString("schoolBankName"),
    schoolBankBranch: t.exposeString("schoolBankBranch"),
    schoolAccountNo: t.exposeString("schoolAccountNo"),
...
builder.mutationField("setHrPolicy", (t) =>
  t.field({
    ...
    args: {
      ...
      orgRegistrationNo: t.arg.string({ required: false }),
      orgAddress: t.arg.string({ required: false }),
      orgPhone: t.arg.string({ required: false }),
      orgEmail: t.arg.string({ required: false }),
      schoolBankName: t.arg.string({ required: false }),
      schoolBankBranch: t.arg.string({ required: false }),
      schoolAccountNo: t.arg.string({ required: false }),
    ...
    resolve: async (_r, args, ctx) => {
      ...
      return setHrPolicy({
        ...
        orgRegistrationNo: args.orgRegistrationNo ?? undefined,
        orgAddress: args.orgAddress ?? undefined,
        orgPhone: args.orgPhone ?? undefined,
        orgEmail: args.orgEmail ?? undefined,
        schoolBankName: args.schoolBankName ?? undefined,
        schoolBankBranch: args.schoolBankBranch ?? undefined,
        schoolAccountNo: args.schoolAccountNo ?? undefined,
