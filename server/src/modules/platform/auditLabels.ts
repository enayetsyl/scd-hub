...
export const AUDIT_KIND_LABELS: Record<AuditEventKind, AuditKindLabel> = {
  ...
  CT_QUESTION_EDITED: { bn: "প্রশ্নের অনুরোধ সংশোধন করেছেন", en: "Corrected a paper request", group: "EXAM" },
  CT_QUESTION_CANCELLED: { bn: "প্রশ্নের অনুরোধ বাতিল করেছেন", en: "Withdrew a paper request", group: "EXAM" },
  CT_QUESTION_DELETED: { bn: "প্রশ্নের অনুরোধ মুছে দিয়েছেন", en: "Deleted a paper request", group: "EXAM" },
