...
export type AuditEventKind =
  ...
  | "TEACHING_NOTE_COMMENTED"     // a teacher left an improvement comment on a teaching note (TN-2, D-#514)
  | "TEACHING_NOTE_COMMENT_ADDRESSED" // a comment marked ADDRESSED (or reopened) by the uploader / P/O (TN-2, D-#514)
