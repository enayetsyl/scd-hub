...
export type AuditEventKind =
  ...
  | "ASSIGNMENT_ITEM_EDITED"      // a delivered assignment was edited after the fact (D-#352)
  | "ASSIGNMENT_ITEM_DELETED"     // a still-DRAFT delivered assignment was deleted (D-#352)
  | "PERMISSION_DENIED";
