...
## Now / next
- **Built (Supervisory read-oversight grant CRUD — server + app, D-#261) [branch `feat/supervisory-grants`
  ...
  **Not verified live.** Highest D-#=**261**. NEXT: owner review → full jest + verifier → push + PR → dev.
