...
- **Built (Saturday Revision SR-4 — the Expo app, COMPLETES the module SR-1..SR-4, prd-sr4.md §2/§3/§4,
  ...
  `tabRevision`/`rev*` BN/EN labels reusing the `@scd/shared` REVISION_* maps. **Server (D-#249):** SR-4 carries the
