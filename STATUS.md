...
- 2026-07-21 (cont. 2): **DATA (prod, applied + verified read-back):** guardian-link fix for Adib Samir — Farzana Yeasmin→Adib reactivated (was active:false, hiding Adib from her portal), Halima Akter→Adib deactivated (owner ruling: wrong link). Adib's sole active guardian is now Farzana; her login shows both children. Root cause context: leftover from earlier guardian-link rewiring; the credentials screen groups by student phone so it showed both kids regardless.
